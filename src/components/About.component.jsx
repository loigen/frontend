      ...
      <div className="min-h-screen bg-gray-100">
        ...
        <section className="px-6 lg:px-24 py-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            I am Dr. Jeb Bohol, PhD, RPsy – Psychologist, a psychotherapist, and
            a researcher. I am operating full-time in Cebu and other parts of
            the Philippines (and even abroad). Throughout my career, I have been
            ...
            been to fight for human rights, environmental conservation, and
            mental health. Public institutions have invited me to be an expert
            witness. Moreover, I have engaged with several private institutions
            to talk about relevant topics in our society.
          </p>
        </section>
        ...
        <section className="px-6 lg:px-24 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed mt-2">
              ...
              international level. I constantly engage with Australian
              colleagues to discuss various cases, find effective therapy
              approaches, and give intensive training to field providers.
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500">
              Jun 2019 to Present · 5 yrs{" "}
            </p>
            <p className="text-gray-600 leading-relaxed mt-2">
              My work is exclusive to war veterans of the United States of
              America. The personnel I usually encounter served in several
              global conflicts throughout the years. I provide intensive
              psychological assessment, interviews, and conduct research to
              assist them in identifying their conditions and necessary help to
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed mt-2">
              ...
              employment both nationally and internationally. Moreover, I
              approve or decline completed psychological tests.
            </p>
          </div>
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500">
              Jun 2017 to Dec 2017 · 7 mos
            </p>
            <p className="text-gray-600 leading-relaxed mt-2">
              Teaching part-time to subjects such as Philosophy, Civics and
              Bible classes to senior high and high school students.
            </p>
          </div>
          <div className="mb-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500">
              Jun 2013 to Dec 2013 · 7 mos
            </p>
            <p className="text-gray-600 leading-relaxed mt-2">
              Worked under the supervision of Department of Social Welfare and
              Development for the MCCT (Modified Cash Transfer) program.
              Together with an assistant, we assessed the responsibility and
              sustainability of the families given financial support by the
              government. Counseling and legal actions especially spousal
              relations and adoption were also conducted.
            </p>
          </div>
        </section>
      </div>
