...
const BookingPage = ({ onBackToActive }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 md:p-8">
      {/* Back Button */}
      <button
        className="bg-teal-600 text-white px-4 py-2 md:px-6 md:py-2 rounded-full mb-4 md:mb-8 shadow-md"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8">
          ...
          <div>
            ...
            <div className="flex justify-between my-4">
              {["8:00 AM", "9:00 AM", "10:00 AM"].map((time) => (
                <button
                  key={time}
                  className="bg-teal-50 border border-teal-600 rounded-lg px-4 py-2 text-teal-600 hover:bg-teal-100"
                >
                  {time}
                </button>
              ))}
        ...
        <div className="bg-white shadow-lg rounded-lg p-4 md:p-6">
          ...
          <p className="mb-4 text-gray-600">
            We aim to make this process smooth and stress-free. Please fill out
            the following details at your own pace. Your information will be
          ...
          <form>
            ...
            <button
              type="submit"
              className="bg-teal-600 text-white px-4 py-2 md:px-6 md:py-2 rounded-lg shadow-md hover:bg-teal-700"
            >
              Proceed
            </button>
          </form>
